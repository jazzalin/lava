...
class SigmaDeltaReset(SigmaDelta):
    def __init__(
            self,
            *,
            shape: ty.Tuple[int, ...],
            ...
            spike_exp: ty.Optional[int] = 0,
            state_exp: ty.Optional[int] = 0) -> None:
        """Sigma delta neuron process that resets its internal states in regular intervals.
        At the moment only ReLu activation is supported.
        Spike mechanism based on accumulated error is also supported.
